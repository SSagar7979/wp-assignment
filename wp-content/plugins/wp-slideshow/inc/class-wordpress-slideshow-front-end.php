...
class WordPress_SlideShow_Front_End {
	...
	public function wp_slideshow_plugin_enqueue_front_scripts() {
		// Slick CSS & JS files
		wp_enqueue_style('slick-css', SIDESHOW__PLUGIN_URL . '_assets/css/slick.css');
		wp_enqueue_style('slick-theme-css', SIDESHOW__PLUGIN_URL . '_assets/css/slick-theme.css');
		wp_enqueue_script('slick-min-js', SIDESHOW__PLUGIN_URL . '_assets/js/slick.min.js', array('jquery'), SIDESHOW__VERSION, true );	
